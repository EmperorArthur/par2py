...
from par2.packets import CreatorPacket, FileDescriptionPacket, MainPacket, FileVerificationPacket
...
def test_parse_file_verification():
    ...
    packet = FileVerificationPacket.from_bytes(good_verification)
    assert packet.is_valid()
    assert packet.id.hex() == "a7d3bd3356339eb611c2b1d1de02c971"
    checksums = packet.checksums
    assert len(checksums) == 21
    assert checksums == ((b'wc\x1c\xa4\xf0\xe0\x84\x19\xb7\x07&\xa4G3:\xb6', b'\x19-\xdc^'),
                         (b'\xb1\x88\xb7\x15\x96\x984J\xfd\xeb\x87\xe9\x1b\xe1\x81\xfc',
                          b'p\x8a\x0c\xf9'),
                         (b'AfA\xfc\x103\xbfK\x08\xa9\x81\xae\x8a\xda\xda\xea', b'\xbf \x18\xec'),
                         (b'Y\x8e\xfchz\x0b{\xc3\xedjs\x8c\x190O\xb4', b'-\xf0c:'),
                         (b'\xf0\x1b#^\xe3V\xda\xe2\xf0-Roa[\xe9\x14', b'\x8e\xb6\x9c@'),
                         (b'\xcf\xdf\x95/\xbd\x91\xc6X\xbf2d 0\xdeEd', b'\x95\xbd\xce\xb3'),
                         (b'\xde\xf9\xb2\xe539\xe8\x0c$\x18\x9f\x1b\x99\xc5\x10\x11', b'_^g\x80'),
                         (b'\x11\xef\tQ\xfd{6o\xba\x16y\tr\xf6\xbdT', b'{e\x86\xea'),
                         (b'\x90\xbe6X\xea\x1fp\x1e\xe4\x95\xbc\x81\x01\x89\xd7\xf4', b'\x939\x13;'),
                         (b'E\x89\xb6-\x12b@&\xbe!\x16\xc5@\xe7\x87\x8c', b'#q\x1b['),
                         (b'B\x88/\x8d\x98x\xae\x87\x95\xaa\x07\x85R\xf9f\xb9', b'\xb72\xb9\x8e'),
                         (b'\xa7\xa1\xbeb\xac\xbf\xa1\xbf\x18\xcc\xe6\x9a\xbeX\xe2\x85',
                          b'\xdd=\xfe\xe6'),
                         (b'\xc8\xd1\x11\x80\xc9V\xe5\xb5\xaf\xc3\xd1\x97\x0c\xe2\x19>', b'=CA\xdb'),
                         (b'\xf0\xe3\xc1\\b7}:!\x1dB\x04\x18\xd4\xa3\xa3', b'\xd5\xc8\xc1\xfd'),
                         (b'\xce,Ty\x80P/\xc0\x08\xd92\xa3\x1f\xf0\x9f\n', b'\xd7\x7f\xcf\x16'),
                         (b'za{\xa5\xd4\xb2\xfa}Y\xef&\xbe\xcc\xcf\xa8i', b'v\x05\xf0\xdd'),
                         (b'\xad?\x13\xbb\xf9\xbe\xb7\xd2\x89\xeb\xb2\xf0\xfduNb', b'{\x0f\xc5\xba'),
                         (b'\xb1a\xca\x8d0\x11\xeb\xd7\xb3so\xb8\xba\xd6\xfcN', b'\xeb\x12%,'),
                         (b'\xda\xccB\xcd\xb2\x88\xad\x16\xa1}\xed\xcd\xd0\xf4\x016', b'5\xa46{'),
                         (b'4\xc4]%\x91h\x83\xa9{N\x8a\xccF\xc4e\xea', b'\xe3\x15\xff\xa6'),
                         (b'\x11\xf4\x87\x1f\x85\xa15U \xc7ysK\xe0\x92v', b'\x17\x82\xb9\xde'))
